  ...
  useEffect(() => {
    if (!user) {
      ...
      const mockOrders: Order[] = [
        { id: '17597098', date: '2023-05-01', status: 'Delivered', total: 50.99 },
        { id: '24603569', date: '2023-05-05', status: 'Processing', total: 35.50 },
        { id: '58050376', date: '2023-05-10', status: 'Shipped', total: 75.25 },
      ];
