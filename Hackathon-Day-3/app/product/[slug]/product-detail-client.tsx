...
export default function ProductDetailClient({ product }: { product: Product }) {
    ...
    // Assuming product.image is an array of images
        ...
        <div className="bg-white min-h-screen">
            <header className="bg-black py-2">
                <nav className="container mx-auto px-4 flex flex-wrap justify-between items-center">
                    ...
                    <ul className={`${isMenuOpen ? "block" : "hidden"} md:flex space-y-2 md:space-y-0 md:space-x-4 lg:space-x-6 text-white justify-center items-center w-full md:w-auto mt-4 md:mt-0`}>
            ...
            <div className="relative h-40 md:h-64 bg-gray-800">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                    ...
                    <p className='text-xs md:text-base text-white mt-2'>Home &gt; <span className="text-orange-400"> &nbsp; Shop Details</span></p>
                </div>
            </div>
                ...
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="md:w-6/12">
                        ...
                        <div className="flex items-center mb-6">
                            ...
                            <button className="ml-4 border border-gray-300 p-2 rounded-full">
                                <Heart className="w-5 h-5" />
                            </button>
                        </div>

                        <div className="mb-6">
                            <p className="font-semibold mb-2">Category: <span className="font-normal">{product.category}</span></p>
                            <p className="font-semibold mb-2">Tags:
                                {product.tags && product.tags.map((tag, index) => (
                                    <span key={index} className="font-normal ml-1">#{tag}</span>
                                ))}
                            </p>
