...
const categories = [
    'Drink', 'Dessert', 'Sandwich', 'Main Course', 'Appetizer', 'Salad', 
    'Breakfast', 'Soup', 'Vegetarian', 'Seafood'
  ];
                ...
                <div className="flex flex-wrap justify-center items-center mx-auto bg-transparent gap-1 sm:gap-2 md:gap-4 mt-8">
                    {paginationItems.map((item, index) => {
                        ...
                        return (
                            <button
                                key={index}
                                //@ts-expect-error: onClick is not assignable to type 'MouseEventHandler<HTMLButtonElement>'
